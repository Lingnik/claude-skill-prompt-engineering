...
- [1. The Agent Harness Paradigm](#1-the-agent-harness-paradigm)
  - [Harness Capabilities](#harness-capabilities)
- [2. Writing Effective Task Instructions](#2-writing-effective-task-instructions)
  - [State the goal before the method](#state-the-goal-before-the-method)
  - [Specify the output, not just the task](#specify-the-output-not-just-the-task)
  - [Use the right level of abstraction](#use-the-right-level-of-abstraction)
  - [Tell the agent what it can skip](#tell-the-agent-what-it-can-skip)
- [3. File and Repo Orientation](#3-file-and-repo-orientation)
  - [Point to the relevant files](#point-to-the-relevant-files)
  - [Describe the repo layout when it's non-obvious](#describe-the-repo-layout-when-its-non-obvious)
  - [Distinguish reference material from working targets](#distinguish-reference-material-from-working-targets)
  - [Use CLAUDE.md for persistent orientation](#use-claudemd-for-persistent-orientation)
- [4. Decomposition Strategies](#4-decomposition-strategies)
  - [When to give it all at once](#when-to-give-it-all-at-once)
  - [When to break it into phases](#when-to-break-it-into-phases)
  - [Let the agent self-decompose](#let-the-agent-self-decompose)
  - [The discovery-implementation gate](#the-discovery-implementation-gate)
- [5. CLAUDE.md and Project-Level Configuration](#5-claudemd-and-project-level-configuration)
  - [What goes in CLAUDE.md](#what-goes-in-claudemd)
  - [CLAUDE.md hierarchy](#claudemd-hierarchy)
  - [CLAUDE.md vs. repeating context in messages](#claudemd-vs-repeating-context-in-messages)
- [6. Claude Code Prompting Surfaces](#6-claude-code-prompting-surfaces)
  - [System prompt and tool customization](#system-prompt-and-tool-customization)
  - [Effort and thinking controls](#effort-and-thinking-controls)
  ...
  - [Hooks](#hooks)
  - [The built-in system prompt](#the-built-in-system-prompt)
  - [Skills](#skills)
- [7. Subagent Prompting](#7-subagent-prompting)
  - [Subagent types as capability profiles](#subagent-types-as-capability-profiles)
  - [Context isolation is absolute](#context-isolation-is-absolute)
  - [Writing effective delegation prompts](#writing-effective-delegation-prompts)
  - [Parallel vs. sequential delegation](#parallel-vs-sequential-delegation)
  - [Guiding the agent's delegation behavior](#guiding-the-agents-delegation-behavior)
  - [Subagent output flows back as a single message](#subagent-output-flows-back-as-a-single-message)
- [8. Cowork Prompting Surfaces](#8-cowork-prompting-surfaces)
  - [Skills are the biggest behavioral lever](#skills-are-the-biggest-behavioral-lever)
  - [File handling: the outputs folder](#file-handling-the-outputs-folder)
  - [Folder mounting for local files](#folder-mounting-for-local-files)
  - [MCP connectors shape capability](#mcp-connectors-shape-capability)
  - [The AskUserQuestion pattern](#the-askuserquestion-pattern)
  - [Scheduled tasks](#scheduled-tasks)
  - [Security constraints are non-negotiable](#security-constraints-are-non-negotiable)
- [9. Chat Prompting Surfaces](#9-chat-prompting-surfaces)
  - [Artifacts are the primary output mechanism](#artifacts-are-the-primary-output-mechanism)
  - [Projects as persistent context](#projects-as-persistent-context)
  - [Conversational iteration is the dominant pattern](#conversational-iteration-is-the-dominant-pattern)
  - [No execution environment](#no-execution-environment)
- [10. The Iteration Loop](#10-the-iteration-loop)
  - [Brief](#brief)
  - [Plan](#plan)
  - [Steer](#steer)
  - [Verify](#verify)
  - [When to skip the loop](#when-to-skip-the-loop)
- [11. Durable and Repeatable Process Prompts](#11-durable-and-repeatable-process-prompts)
  - [Design for re-execution](#design-for-re-execution)
  - [Include verification steps](#include-verification-steps)
  - [Save process prompts as files or CLAUDE.md sections](#save-process-prompts-as-files-or-claudemd-sections)
  - [Parameterize when possible](#parameterize-when-possible)
- [12. Model Behavioral Implications](#12-model-behavioral-implications)
  - [Opus 4.6 — constrain the explorer](#opus-46--constrain-the-explorer)
  - [Sonnet 4.6 — the efficient default](#sonnet-46--the-efficient-default)
  - [Haiku 4.5 — set quality expectations](#haiku-45--set-quality-expectations)
- [13. Anti-Patterns by Platform](#13-anti-patterns-by-platform)
  - [General Anti-Patterns (All Harnesses)](#general-anti-patterns-all-harnesses)
  - [Claude Code Anti-Patterns](#claude-code-anti-patterns)
  - [Cowork Anti-Patterns](#cowork-anti-patterns)
  - [Chat Anti-Patterns](#chat-anti-patterns)
  - [Agent-to-Subagent Anti-Patterns](#agent-to-subagent-anti-patterns)
